// scripts/importMinimalVillageChief.cjs
...
(async () => {
  await connectMongo();
  try {
    console.log('📖 Importando villagechief mínimo...');
    
    const data = fs.readFileSync(path.join(MINIMAL_BASE, 'villagechief.json'), 'utf8');
