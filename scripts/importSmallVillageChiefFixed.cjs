// scripts/importSmallVillageChiefFixed.cjs
...
(async () => {
  await connectMongo();
  try {
    console.log('📖 Importando villagechief pequeño con estructura corregida...');
    
    const data = fs.readFileSync(path.join(SMALL_BASE, 'villagechief.json'), 'utf8');
