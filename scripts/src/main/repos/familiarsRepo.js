...
exports.upsertFamiliars = upsertFamiliars;
// src/main/repos/familiarsRepo.ts
const mongoose_1 = __importStar(require("mongoose"));
const FamiliarSchema = new mongoose_1.Schema({
    _id: { type: String }, // usa tu familiar.id
    name: String,
    level: Number,
    // ... lo que tengas
}, { timestamps: true, strict: false });
exports.Familiar = mongoose_1.default.models.Familiar || mongoose_1.default.model('Familiar', FamiliarSchema);
async function upsertFamiliars(familiars) {
    ...
    for (const familiar of familiars) {
        ...
        await exports.Familiar.replaceOne({ _id: familiarId }, { ...familiar, _id: familiarId }, { upsert: true });
    }
}
