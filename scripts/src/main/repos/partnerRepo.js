...
exports.Partner = mongoose_1.default.models.Partner || mongoose_1.default.model('Partner', PartnerSchema);
async function upsertPartner(partner) {
    // Para colecciones únicas: un único replaceOne con _id: "single"
    await exports.Partner.replaceOne({ _id: 'single' }, { ...partner, _id: 'single' }, { upsert: true });
}
